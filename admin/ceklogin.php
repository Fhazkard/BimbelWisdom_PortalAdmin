...
$tu = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM t_u WHERE username='$myusername' and password='$mypassword'"));

$kepsek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM kep_sek WHERE username='$myusername' and password='$mypassword'"));
