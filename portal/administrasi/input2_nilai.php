...
<h2 align="center">Input Perkembangan<?php $kls = mysql_fetch_array(mysql_query("SELECT namakelas FROM kelas_siswa WHERE idkelas_siswa = $kelas")); echo $kls['namakelas']; ?></h2><hr />
<h3 align="center">
</h3>
