...
<body>
	<div class="page" id="tablewrapper">
        ...
        <table width="708" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
            <thead>
                <tr>
				  <th width="100"><h3>ID Siswa</h3></th>
                  <th width="100"><h3>Username</h3></th>
                  <th width="300"><h3>Nama</h3></th>
                  <th width="300"><h3>Sekolah</h3></th>
				  <th width="333"><h3>Alamat</h3></th>
                  <th width="178"><h3>Status</h3></th>
		 ...
		 if($_SESSION['level']=="admin" || $_SESSION['level']=="tu"){
			echo "
			<a href=edit_siswa.php?id=$baris[idsiswa]><img src=icon/update.png border=0></a>&nbsp;|
			<a href=hapus_siswa.php?id=$baris[idsiswa] onClick=\"return confirm('Apakah Anda Yakin Akan Menghapus Data?')\"><img src=icon/hapus.png border=0></a></td>
            </tr>";
			}}
			?>
            </tbody>
