...
$query = mysql_fetch_array(mysql_query("SELECT password FROM siswa WHERE username = '$_SESSION[user]'"));
if($query['password']==$lama){
$sql = mysql_query("UPDATE siswa SET password='$baru' WHERE username = '$_SESSION[user]'");
