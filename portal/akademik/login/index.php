...
?>
<html>
<title>Login Sistem Informasi Bimbel Wisdom</title>
<style type="text/css">
<!--
.judul {
...
<div align="center">
  <p>&nbsp;</p>
  <h1 class="judul"><strong>.::LOGIN SISTEM INFORMASI BIMBEL WISDOM::.</strong></h1>
<br /><br />
  <form method="post" action="login.php">
    <table width="329" height="246" border="0" align="center" background="456.png">
    <tr>
