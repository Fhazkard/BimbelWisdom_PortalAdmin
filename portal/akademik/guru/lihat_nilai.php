        ...
        <table width="708" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
            <thead>
                <tr>
				  ...
				  <th width="250"><h3>Keterangan</h3></th>
				  <th width="300"><h3>Perkembangan</h3></th>
		 ...
		 if($_SESSION['level']=="admin"){
			echo "<td>
			<a href=edit_nilai.php?id=$baris[idperkembangan]><img src=icon/update.png border=0></a>&nbsp;|
			<a href=hapus_nilai.php?id=$baris[idperkembangan] onClick=\"return confirm('Apakah Anda Yakin Akan Menghapus Data?')\"><img src=icon/hapus.png border=0></a>
			</td>
            </tr>";
			}}
			?>
