...
<ul class="acc" id="acc">
	<li>
		...
		<div class="acc-section">
			...
			<a href="?page=lihat_nilai"><center><img src="images/grafik.png" width="50" height="50" border="0"><br />
			Lihat Nilai
			  </center></a>
			</div>
		</div>
	...
	<li>
		...
		<div class="acc-section">
			<div class="acc-content">
			<a href="http://www.bimbelwisdom.com/download.php"><center><img src="images/download.png" width="50" height="50" border="0"><br/>
			Input & Download Materi
			</center></a><br/>
			</div>
		</div>
	</li>
